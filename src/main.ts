...
const commands: Record<string, AxiCliCommand<AppContext>> = {
  ...
  "mail": sub(
    ...
    [
      ...
      "  mail read <id> [--full]",
      "  mail send --to <a,b> --subject \"...\" --body \"...\" [--send] [--execute]",
...
const COMMAND_HELP: Record<string, string> = {
  ...
  mail: [
    ...
    "      [--attach path,...] [--mailbox <upn>] [--send] [--execute]",
    "      without --execute prints a preview only (dry run)",
    "      --execute saves a DRAFT; add --send to deliver it in the same step",
    "  msgraph-axi mail send --draft <id> [--execute]   deliver a saved draft",
